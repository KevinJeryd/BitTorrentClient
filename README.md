Proper read me will be added when project is done, currently implementing threading and optimising the client. Documentation will be added after threading has been added to the client.
